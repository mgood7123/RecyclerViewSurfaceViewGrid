package androidx.recyclerview.widget2.scrolling;
...
import androidx.recyclerview.widget2.scrolling.RecyclerView.ItemAnimator.ItemHolderInfo;
...
public class RecyclerView extends ViewGroup implements ScrollingView,
    ...
    public void addItemDecoration(@NonNull ItemDecoration decor, int index) {
        if (mLayout != null) {
            mLayout.assertNotInLayout("Cannot add item decoration during a scroll  or"
                    + " layout");
        }
    ...
    public void removeItemDecoration(@NonNull ItemDecoration decor) {
        if (mLayout != null) {
            mLayout.assertNotInLayout("Cannot remove item decoration during a scroll  or"
                    + " layout");
        }
    ...
    public final void suppressLayout(boolean suppress) {
        if (suppress != mLayoutSuppressed) {
            assertNotInLayout("Do not suppressLayout in layout or scroll");
            if (!suppress) {
    ...
    public void invalidateItemDecorations() {
        ...
        if (mLayout != null) {
            mLayout.assertNotInLayout("Cannot invalidate item decorations during a scroll"
                    + " or layout");
        }
        markItemDecorInsetsDirty();
        requestLayout();
