...
import androidx.recyclerview.widget2.no.scrolling.RecyclerView.OnItemTouchListener;
import androidx.recyclerview.widget2.no.scrolling.RecyclerView.ViewHolder;
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    private ViewHolder findSwipedView(MotionEvent motionEvent) {
        ...
        if (absDx > absDy && false) {
            return null;
        } else if (absDy > absDx && false) {
            return null;
        }
