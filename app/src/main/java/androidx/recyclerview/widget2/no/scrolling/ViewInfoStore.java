...
import static androidx.recyclerview.widget2.no.scrolling.ViewInfoStore.InfoRecord.FLAG_APPEAR;
import static androidx.recyclerview.widget2.no.scrolling.ViewInfoStore.InfoRecord.FLAG_APPEAR_AND_DISAPPEAR;
import static androidx.recyclerview.widget2.no.scrolling.ViewInfoStore.InfoRecord.FLAG_APPEAR_PRE_AND_POST;
import static androidx.recyclerview.widget2.no.scrolling.ViewInfoStore.InfoRecord.FLAG_DISAPPEARED;
import static androidx.recyclerview.widget2.no.scrolling.ViewInfoStore.InfoRecord.FLAG_POST;
import static androidx.recyclerview.widget2.no.scrolling.ViewInfoStore.InfoRecord.FLAG_PRE;
import static androidx.recyclerview.widget2.no.scrolling.ViewInfoStore.InfoRecord.FLAG_PRE_AND_POST;
