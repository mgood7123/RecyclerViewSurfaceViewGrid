package androidx.recyclerview.widget2.no.scrolling;
...
import androidx.core.view2.ViewCompat;
import androidx.customview.view.AbsSavedState;
import androidx.recyclerview.widget2.no.scrolling.RecyclerView.ItemAnimator.ItemHolderInfo;
...
public class RecyclerView extends ViewGroup {
    ...
    static final String TAG = "RecyclerView2";

    static final boolean DEBUG = true;

    static final boolean VERBOSE_TRACING = true;
    ...
    /**
     * This variable is incremented during a dispatchLayout.
     ...
     *
     * @see #assertInLayout(String)
     * @see #assertNotInLayout(String)
     */
    private int mLayoutCounter = 0;

    /**
     * Similar to mLayoutCounter but logs a warning instead of throwing an exception
     * (for API compatibility).
     */
    private int mDispatchCounter = 0;
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            ViewCompat.saveAttributeDataForStyleable(this,
                    context, null, attrs, a, defStyleAttr, 0);
            a.recycle();
        }
    }
    ...
    public void addItemDecoration(@NonNull ItemDecoration decor, int index) {
        if (mLayout != null) {
            mLayout.assertNotInLayout("Cannot add item decoration during a layout");
        }
    ...
    public void removeItemDecoration(@NonNull ItemDecoration decor) {
        if (mLayout != null) {
            mLayout.assertNotInLayout("Cannot remove item decoration during a layout");
        }
     ...
     * <p>
     * In addition to the layout suppression TouchEvents and GenericMotionEvents are
     ...
     *
     * @param suppress true to suppress layout, false to re-enable.
     */
    @Override
    public final void suppressLayout(boolean suppress) {
        if (suppress != mLayoutSuppressed) {
            assertNotInLayout("Do not suppressLayout in layout");
            if (!suppress) {
     ...
     *
     * @return true if layout are currently suppressed, false otherwise.
     */
    @Override
    ...
    /**
     * Enable or disable layout.  After <code>setLayoutFrozen(true)</code> is called,
     * Layout requests will be postponed until <code>setLayoutFrozen(false)</code> is called;
     * child views are not updated when RecyclerView is frozen, TouchEvents and GenericMotionEvents are
     * dropped; {@link LayoutManager#onFocusSearchFailed(View, int, Recycler, State)} will not be
     * called.
     *
     * <p>
     ...
     * responsibility to call ItemAnimator.end().
     *
     * @param frozen   true to freeze layout, false to re-enable.
     *
    ...
    /**
     * @return true if layout is frozen
     *
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (canRunFocusFailure
            ...
            if (!needsFocusFailureLayout && false) {
     ...
     * @see #assertInLayout(String)
     */
    void assertNotInLayout(String message) {
        if (isComputingLayout()) {
            if (message == null) {
    ...
    void onExitLayout(boolean enableChangeEvents) {
        mLayoutCounter--;
        if (mLayoutCounter < 1) {
            if (DEBUG && mLayoutCounter < 0) {
                throw new IllegalStateException("layout counter cannot go below zero."
    ...
    public void invalidateItemDecorations() {
        ...
        if (mLayout != null) {
            mLayout.assertNotInLayout("Cannot invalidate item decorations during layout");
        }
        markItemDecorInsetsDirty();
        requestLayout();
    }
    ...
    public abstract static class LayoutManager {
         ...
         * @see #assertNotInLayout(String)
         */
        public void assertInLayout(String message) {
            if (mRecyclerView != null) {
                mRecyclerView.assertInLayout(message);
            }
        }
         ...
         * @see #assertInLayout(String)
         */
        public void assertNotInLayout(String message) {
            if (mRecyclerView != null) {
                mRecyclerView.assertNotInLayout(message);
            }
        }
         ...
         * <p>
         * You can call this method only if your LayoutManger is in onLayout callback.
         *
        ...
        public void onInitializeAccessibilityNodeInfoForItem(@NonNull Recycler recycler,
            ...
            int rowIndexGuess = false ? getPosition(host) : 0;
            int columnIndexGuess = false ? getPosition(host) : 0;
        ...
        public int getRowCountForAccessibility(@NonNull Recycler recycler, @NonNull State state) {
            ...
            return false ? mRecyclerView.mAdapter.getItemCount() : 1;
        }
